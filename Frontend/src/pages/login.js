export function LoginPage() {
  ...
  $container.innerHTML = `
<div class="flex justify-center items-center h-screen bg-violet-400">
  <div class=" p-8 rounded-lg shadow-lg w-full max-w-md">
    ...
    <form id="loginForm" class="space-y-4">
      <div>
        ...
        <p class="text-indigo-800">¿No tiene una cuenta? 
        
        <a href="/register" class="text-lg hover:underline transition-colors duration-200 ${location.pathname === '/register' ? 'text-pink-700' : ''
    }">Registrarse</a>
        </p>
      </div>
      </div>
